...
do
	...
	local DescendantAdded = function(Descendant)
		if IsA(Descendant, "Accoutrement") and OptionsHatDrop then
			...
			elseif setscriptable then
				...
				pcall(NewIndex, Descendant, "BackendAccoutrementState", 0)
			end
			...
			if Attachment then
				...
				if IsA(Parent, "BasePart") then
					...
					if MeshId then
						...
						local Accoutrement = Parent:FindFirstAncestorWhichIsA("Accoutrement")
	...
	local OnCharacterAdded = function(NewCharacter)
		if NewCharacter ~= Rig then
			...
			Character.PrimaryPart = Rig.Head
			...
			if HumanoidRootPart then
				...
				if OptionsChangePrimaryPart then
					...
					HumanoidRootPart.CFrame = CFramenew(RootPartCFrame.X, FallenPartsDestroyHeight + 20 * ( 1 + OptionsBreakJointsDelay ) + ( OptionsSetCharacter and 225 or 0 ), RootPartCFrame.Z) * CFrame.Angles(1.57, 0, 0)
				elseif OptionsHatDrop then
					taskspawn(function()
						local RootPartCFrame = RigHumanoidRootPart.CFrame
						RootPartCFrame = CFramenew(RootPartCFrame.X, FallenPartsDestroyHeight + 3, RootPartCFrame.Z)
	...
	local OnPostSimulation = function()
		...
		local AntiSleep = mathsin(Time * 15) * 0.0015 * Vector3one
	...
	local OnPreRender = function()
		...
		for Index, Table in next, Aligns do
			...
			if Part0.ReceiveAge == 0 and not GetJoints(Part0)[1] and not IsGrounded(Part0) then
...
Empyrean = Start({
	Accessories = {
		...
		{ MeshId = "14255522247", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "14255543546" },--14255556501
		{ MeshId = "14255522247", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "14255544465" },--14255562939
		{ MeshId = "18640914129", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "18640914168" },--18641142410
		{ MeshId = "17374767929", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "17374768001" },--18641142410
		{ MeshId = "90736849096372", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "79186624401216" },--90960046381276
		{ MeshId = "90653511854016", Name = "LeftLowerArm", Offset = CFrame.identity, TextureId = "72193962238808" },--82404150383568
		{ MeshId = "12344207333", Names = { "LeftLowerArm", "RightLowerArm" }, Offset = CFrame.Angles(1.3, 0, 0), TextureId = "12344207341" },--12344545199
		...
		{ MeshId = "18640901641", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "18640901676" },--18641187217
		{ MeshId = "17387586286", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "17387586304" },--17387616772
		{ MeshId = "139733645770094", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "130809869695496" },--82942681251131
		...
		{ MeshId = "14255522247", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "14255543546" },--14255554762
		{ MeshId = "14255522247", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "14255544465" },--14255560646
		{ MeshId = "18640914129", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "18640914168" },--18641077392
		{ MeshId = "17374767929", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "17374768001" },--17374846953
		{ MeshId = "105141400603933", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "71060417496309" },--102599402682100
		{ MeshId = "77814141389117", Name = "RightLowerArm", Offset = CFrame.identity, TextureId = "86835481875891" },--108224319902592
		{ MeshId = "12344206657", Names = { "LeftLowerArm", "RightLowerArm" }, Offset = CFrame.Angles(1.3, 0, 0), TextureId = "12344206675" },--12344591101
		...
		{ MeshId = "18640901641", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "18640901676" },--18641157833
		{ MeshId = "17387586286", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "17387586304" },--17401151565
		{ MeshId = "99608462237958", Names = { "LeftLowerArm", "LeftLowerLeg", "RightLowerArm", "RightLowerLeg" }, Offset = CFrame.new(0, 0.16, 0) * CFrame.Angles(0, 0, 1.57), TextureId = "130809869695496" },--140395948277978
		...
		{ MeshId = "4819720316", Name = "Torso", Offset = CFrame.Angles(0, 0, - 0.245), TextureId = "4819722776" },--4819740796	
		{ MeshId = "14241018198", Name = "UpperTorso", Offset = CFrame.new(0, - 0.2, 0), TextureId = "14251599953" },--14255528083
		{ MeshId = "110684113028749", Name = "UpperTorso", Offset = CFrame.new(0, - 0.2, 0), TextureId = "70661572547971" },--138364679836274
		{ MeshId = "18640899369", Name = "UpperTorso", Offset = CFrame.new(0, - 0.2, 0), TextureId = "18640899481" },--18641046146
		{ MeshId = "133147477794468", Name = "UpperTorso", Offset = CFrame.new(0, - 0.2, 0), TextureId = "87928159560963" },--100856932339214

		-- Heads

		{ MeshId = "13058343355", Name = "Head", Offset = CFrame.Angles(0, 3.141, 0), TextureId = "13058343394" },--13058406993	
	},
